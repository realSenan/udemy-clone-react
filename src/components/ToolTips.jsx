...
const ToolTips = ({ product, left }) => {
    return (
        <div className="absolute -top-28 z-10 px-4" style={{ left: left }}>
            <div
                className={` w-[22.5rem] min-h-[28.5rem] shadow-dropDownBox p-4 bg-white PopDown `}
            >
